...
const MANDI_CENTERS = [
  {
    id: "pat-01",
    name: "Patna Central APMC Yard #04",
    district: "Patna",
    distance: "12 km",
  },
  {
    id: "bik-02",
    name: "Bikramganj Procurement Hub",
    district: "Rohtas",
    distance: "28 km",
  },
  {
    id: "dan-03",
    name: "Danapur Grain Mandi Silo Bay",
    district: "Patna",
    distance: "8 km",
  },
  {
    id: "man-04",
    name: "Maner APMC Collection Point",
    district: "Patna",
    distance: "19 km",
  },
];
...
export default function FarmerSlotBooking() {
  ...
  const selectedCrop =
    CROP_CATALOG.find(
      (c) => c.id === bookingData.selectedCropId
    ) || CROP_CATALOG[0];
  ...
  const estimatedQuintals =
    parseFloat(bookingData.quantityQtl) || 0;

  const grainWeightKg = Math.round(
    estimatedQuintals * 100
  );

  const estimatedPayout =
    estimatedQuintals * selectedCrop.mspRate;

  const calculatedEstMinutes = Math.round(
    (grainWeightKg / 500) * 60
  );
  ...
  const fetchSlotsByCentre = async (centreId) => {
    ...
    try {
      ...
      setApiError(
        error.message ||
          "Unable to load slots for this centre."
      );
  ...
  const fetchSlotsByCentreAndDate = async (
    centreId,
    date
  ) => {
  ...
  const fetchSlotDetails = async (slotId) => {
    ...
    try {
      ...
      console.error(
        "Slot details API error:",
        error
      );

      setApiError(
        error.message ||
          "Unable to load selected slot details."
      );
    ...
    try {
      ...
      setBookingResult({
        ...
        estimatedProcessingTime:
          ...
          `${calculatedEstMinutes} minutes`,

        allocatedBay:
          data.allocatedBay ||
          data.bay ||
          "Bay 02 - Scale Terminal A",
              ...
              <div className="rounded-3xl border border-emerald-900/10 bg-white/95 p-6 shadow-xl backdrop-blur-md sm:p-8 lg:col-span-7">
                ...
                <div className="border-b border-gray-100 pb-4">
                  ...
                  <p className="mt-1 text-xs text-gray-500">
                    Select your commodity, volume, and
                    designated procurement centre.
                  </p>
                  ...
                  <div className="flex items-center gap-3 rounded-2xl border border-blue-200 bg-blue-50/70 p-3.5 text-xs text-blue-900">
                    ...
                    <div>
                      ...
                      <div className="font-bold">
                        Rate Benchmark: 500 kg/hr
                      </div>

                      <div className="text-[11px] text-blue-800">
                        Estimated unload & testing:
                        ~{calculatedEstMinutes} minutes
                      </div>
                ...
                <div className="mt-5 space-y-5">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-[10px] text-gray-400">
                      ...
                      calls the centre + date slots API.
                    </p>
